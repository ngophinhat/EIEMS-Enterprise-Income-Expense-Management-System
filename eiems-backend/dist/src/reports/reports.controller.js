...
let ReportsController = class ReportsController {
    ...
    reportDay(year, month, day) {
        return this.reportsService.reportByDay(Number(year), Number(month), Number(day));
    }
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "reportDay", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "reportMonth", null);
__decorate([
    (0, common_1.Get)('quarter'),
    __param(0, (0, common_1.Query)('year')),
    __param(1, (0, common_1.Query)('quarter')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "reportQuarter", null);
__decorate([
    (0, common_1.Get)('year'),
    __param(0, (0, common_1.Query)('year')),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "reportYear", null);
